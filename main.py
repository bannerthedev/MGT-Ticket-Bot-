...
GUILD_ID = 1393251883090710670  # Guild ID where command registers
# Add as many staff role IDs as you want here:
STAFF_ROLE_IDS = [1481783566567342210, 1498148295892140222, 1507166219713642637, 1498150340170875021, 1498150536858308639, 1498150907613941810 ]  # example: [role_id1, role_id2, ...]
